...
export const cities = mockCities;
...
export const exclusiveOffers = [
  ...
  },
  {
    ...
    description: "Extra savings across selected India city hotels.",
    code: "INDIA18",
    priceOff: 18,
    expiryDate: "Sep 20",
  ...
  },
  {
    ...
    description: "Book early and save on premium international properties.",
    code: "LUXURY30",
    priceOff: 30,
    expiryDate: "Sep 25",
  ...
  },
  {
    ...
    description: "Limited-time discount for quick weekend breaks.",
    code: "WEEKEND12",
    priceOff: 12,
    expiryDate: "Oct 31",
    applicableScope: "all",
  ...
  },
  {
    _id: 5,
    title: "Family Escape",
    description: "Family-friendly offer for larger stays in India.",
    code: "FAMILY15",
    priceOff: 15,
    expiryDate: "Nov 30",
    applicableScope: "india",
  ...
  {
    _id: 6,
    title: "Business Traveler Pro",
    description: "International business trip savings on premium rooms.",
    code: "BIZ20",
    priceOff: 20,
    expiryDate: "Dec 31",
    applicableScope: "international",
