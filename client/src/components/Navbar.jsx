      ...
      <div className="hidden md:flex items-center gap-4">
        <form onSubmit={onSearchSubmit} className="flex items-center gap-2">
          <input
            ...
            className="border border-gray-300 rounded-full px-4 py-1.5 text-sm outline-none w-40"
          />
          <button
            type="submit"
            className="rounded-full border border-gray-300 px-3 py-1.5 cursor-pointer"
          >
            <img
